...
export function ServicesShowcase() {
  return (
    <section className="relative overflow-hidden bg-brand-900 py-24" aria-label="Leistungen">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_30%,#B6FF3B12,transparent_55%)]" />
